  ...
  return (
    <section className="relative">
      ...
      <div className="flex flex-col items-center justify-center min-h-[90vh] relative">
        <h1 className="text-4xl md:text-9xl  font-bold text-gray-900 relative">
          {" "}
          <HiOutlineXMark className="text-4xl  text-gray-900 rotate-[-20deg] font-bold absolute top-[-100%] md:top-[-30%]  left-[0%] " />
          404{" "}
          <FaRegCircle className="absolute top-[10%] left-[100%] text-xl text-gray-900 " />
        </h1>
