...
{visible ? (
 ...
 <div className='my-4'>
  <label for="name" className='flex justify-between text-nowrap items-center mb-2'><span className='text-gray-600'>Name :</span> <span>{formik.errors.name && formik.touched.name ? (<div className='text-red-600  font-semibold text-sm  bg-red-200 w-fit px-3 ml-auto rounded'> {formik.errors.name}</div>):('')}</span></label>
...
<label for="email" className='flex justify-between text-nowrap items-center mb-2'> <span className="text-gray-600">Email :</span>
  <span>
...
<label for="password" className='flex text-nowrap justify-between items-center mb-2'><span className='text-gray-600'>Password :</span> <span>{formik.errors.password && formik.touched.password ? (<div className='text-red-600  font-semibold text-sm  bg-red-200 w-fit px-3 ml-auto rounded'> {formik.errors.password}</div>):('')}</span></label>
...
<div className='my-2'>
 ...
 <div className='mb-2 mt-4 relative'>
  <label for="passwordConfirm" className='flex text-nowrap justify-between items-center mb-2'><span className='text-gray-600'>Rewrite password :</span><span>{formik.errors.passwordConfirm && formik.touched.passwordConfirm ? (<div className='text-red-600  font-semibold text-sm  bg-red-200 w-fit px-3 ml-auto rounded'> {formik.errors.passwordConfirm}</div>):('')}</span></label>
