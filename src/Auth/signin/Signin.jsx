...
export default function Signin({ setShowModel }) {
 ...
 <form ref={formRef} onSubmit={formik.handleSubmit} className='mt-8 w-[90%] max-[350px]:w-[95%] max-[350px]:top-[48%] md:w-[70%] lg:w-[50%] xl:w-[50%] 2xl:w-[40%] max-[425px]:my-10 bg-white absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-10 rounded-lg'>
...
<div className='my-2'>
 ...
 <div>Already have an account? <button type='button' className='underline  text-gray-600 inline-block '  onClick={() => setShowModel('login')} >Login</button></div>
 </div>
